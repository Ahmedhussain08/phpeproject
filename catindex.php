...
#card .card-title,
		...
		#card:hover {
			...
			border: 2px solid #8D649B !important;
...
?>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(images/img2.jpg);">
				...
				<div class="item-slick1" style="background-image: url(images/img3.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="slideInUp" data-delay="1600">
								<a href="#card" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
				...
				<div class="item-slick1" style="background-image: url(images/img1.png);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
	...
	<section class="bg0 p-t-23 p-b-23">
		<div class="container">
			...
			<section style="background-color:#71649b !important;" class="p-2 ">
				...
				<div class="row text-center  ">
					<?php
                        if(isset($_GET['catdetail']))
                        {
							...
							<div id="card" class="card my-2" style="width: 15rem;">
								<img src="admin/productimages/<?php echo $row[4] ?>" class="card-img-top img-fluid" alt="...">
								<div class="card-body bg-white">
									<h5 class="card-title  mb-3"> <?php echo $row[1] ?></h5>
									<p class="card-text  text-muted mt-2"> <?php echo $row[3] ?> </p>
									<p href="" class="text-primary mt-2 fw-bold"> RS. <?php echo $row[2] ?> </p>
									<a href="product-detail.php?productid=<?php echo $row[0] ?>" class=" btn text-white my-3 bg1  hov-btn1"> BUY NOW  </a>
