...
if(isset($_POST['btn'])){
    ...
    $editsql = mysqli_query($con, "UPDATE `product` SET `pname` = '$editname', `pprice` = '$editprice', `pdesc` = '$editdesc', `catID` = '$editcatid', `pimage` = '$imagename' WHERE `pid` = '$editpro'");
...
<form method="POST" class="mt-3 p-3" enctype="multipart/form-data">
    <div class="form-group row">
        ...
        <div class="col-md-6 my-4  text-white">
            ...
            <input value="<?php echo $result[2] ?>" name="price" type="number" class="form-control text-white" id="price" placeholder="Enter price" required>
        </div>
        <div class="col-md-6 my-4  text-white">
            <label for="desc">Enter PRODUCT DESCRIPTIONS</label>
            <input value="<?php echo $result[3] ?>" name="desc" type="text" class="form-control text-white" id="desc" placeholder="Enter description" required>
        </div>
        ...
        <div class="col-md-12 my-4  text-white">
