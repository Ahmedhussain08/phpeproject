...
?>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(images/img1.avif);">
				...
				<div class="item-slick1" style="background-image: url(images/img2.avif);">
					<div class="container h-full">
				...
				<div class="item-slick1" style="background-image: url(images/img3.avif);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
